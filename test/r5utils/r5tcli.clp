...
/*  ================================================================ */
   ...
   DCL        VAR(&PKG)    TYPE(*CHAR) LEN(10) VALUE('R5TCL')
...
/*  ---------------------------------------------------------------  */
   ...
   CRTBNDRPG  PGM(&LIB/R5TCL) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TCL01) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TCL01A) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TCL02) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TCL02A) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
