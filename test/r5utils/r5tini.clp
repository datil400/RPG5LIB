...
/*  ================================================================ */
   ...
   DCL        VAR(&PKG)    TYPE(*CHAR) LEN(10) VALUE('R5TIN')
...
/*  ---------------------------------------------------------------  */
   ...
   CRTBNDRPG  PGM(&LIB/R5TIN) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TIN01) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TIN02) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
