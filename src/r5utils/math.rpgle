...
//  El valor m�s peque�o de la lista.
//
...
//
//  'high_nbr' es el l�mite superior.
//  'low_nbr' es el l�mite inferior. Cero si no se indica.
...
dcl-proc r5_random_number export;
   ...
   //  'seed' es una semilla utilizada en la generaci�n del n�mero
   //  aleatorio. En la primera llamada su valor es cero y el
   //  generador de n�meros toma la fecha y hora actual para generar
   //  una. La funci�n CEERAN0 actualiza el valor de la semilla
...
//
//  Si n�mero es negativo, devuelve -1
//  Si n�mero es positivo, devuelve 1
//  Si n�mero es cero, devuelve 0
//
