...
/*  ================================================================ */
   ...
   DCL        VAR(&PKG)    TYPE(*CHAR) LEN(10) VALUE('R5DATTIM')
...
/*  Verificar versión del sistema operativo                          */
   ...
   CHKOBJ     OBJ(R5STRING) OBJTYPE(*SRVPGM)
...
/*  ---------------------------------------------------------------  */
   ...
   CRTRPGMOD  MODULE(QTEMP/DATES) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTRPGMOD  MODULE(QTEMP/TIME) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTRPGMOD  MODULE(QTEMP/UXTIME) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   RTVMBRD    FILE(&LIB/&RPGLESRC) MBR(R5DATTIMB) TEXT(&TEXT)
...
/*  ===============================================================  */
LIMPIEZA:
   DLTMOD     MODULE(QTEMP/DATES)
   MONMSG     CPF0000
   DLTMOD     MODULE(QTEMP/TIME)
   MONMSG     CPF0000
