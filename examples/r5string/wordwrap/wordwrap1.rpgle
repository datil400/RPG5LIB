...
//  WORDWRAP1
//
//  SQL UDTF for Word Wrap
//
//  Author: datil400@gmail.com
//
//  Compile:
//
//  CRTBNDRPG  PGM(&LIB/WORDWRAP1)
...
dcl-c SQL_UNEXPECTED_ERROR  '38999';   // SQLSTATE = 38xxx (Ixx - Zxx)
...
dcl-pi udtf_word_wrap extpgm('WORDWRAP1');
...
dcl-proc load_wrapped_text;
   ...
   max_lines = 0;
   r5_word_wrap(*NULL: text: width: %paddr(compute_max_lines));
   out_text_ptr = %alloc(max_lines * %size(out_line));

   r5_word_wrap(*NULL: text: width: %paddr(store_line));
