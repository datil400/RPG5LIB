...
/*  ================================================================ */
   ...
   DCL        VAR(&PKG)    TYPE(*CHAR) LEN(10) VALUE('R5TEN')
...
/*  ---------------------------------------------------------------  */
   ...
   CRTBNDRPG  PGM(&LIB/R5TEN) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TEN01) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TEN02) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
