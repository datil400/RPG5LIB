...
/*  ================================================================ */
   ...
   DCL        VAR(&PKG)    TYPE(*CHAR) LEN(10) VALUE('R5TMT')
...
/*  Verificar versión del sistema operativo                          */
   ...
   CHKOBJ     OBJ(RPG5LIB) OBJTYPE(*BNDDIR)
   CHKOBJ     OBJ(IBMIUNIT/IBMIUNIT) OBJTYPE(*BNDDIR)
   CHKOBJ     OBJ(OSSILE/OSSILE) OBJTYPE(*BNDDIR)
...
/*  ---------------------------------------------------------------  */
   ...
   CRTBNDRPG  PGM(&LIB/R5TMT) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TMT01) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TMT03) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TMT04) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TMT05) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
   CRTBNDRPG  PGM(&LIB/R5TMT06) SRCFILE(&LIB/&RPGLESRC) +
              DBGVIEW(&DBG)
