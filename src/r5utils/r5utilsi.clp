...
/*  ================================================================ */
   ...
   DCL        VAR(&PKG)    TYPE(*CHAR) LEN(10) VALUE('R5UTILS')
...
/*  ================================================================ */
   ...
   ADDBNDDIRE BNDDIR(&LIB/RPG5LIB) OBJ((R5UTILS)) +
              POSITION(*FIRST)
   MONMSG     MSGID(CPF0000)
...
/*  ---------------------------------------------------------------  */
             ...
             CRTRPGMOD  MODULE(QTEMP/ERRNO) +
                          SRCFILE(&LIB/&RPGLESRC) DBGVIEW(&DBG)
             CRTRPGMOD  MODULE(QTEMP/APIERROR) +
                          SRCFILE(&LIB/&RPGLESRC) DBGVIEW(&DBG)
             CRTRPGMOD  MODULE(QTEMP/JOBLOG) +
                          SRCFILE(&LIB/&RPGLESRC) DBGVIEW(&DBG)
             CRTRPGMOD  MODULE(QTEMP/CALLLEVEL) +
                          SRCFILE(&LIB/&RPGLESRC) DBGVIEW(&DBG)
             CRTRPGMOD  MODULE(QTEMP/WHO_AM_I) +
                          SRCFILE(&LIB/&RPGLESRC) DBGVIEW(&DBG)
             CRTRPGMOD  MODULE(QTEMP/IIF) +
                          SRCFILE(&LIB/&RPGLESRC) DBGVIEW(&DBG)
